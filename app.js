...
function showQuestion() {
    ...
    for (var i = 0; i < questions[indexNum].options.length; i++) {
        ...
        <button class="btn btn-success px-5 rounded-pill w-100" onclick="checkAns('${questions[indexNum].options[i]}','${questions[indexNum].answer}')">${questions[indexNum].options[i]}</button>
    </div>`
    }
}
showQuestion();
